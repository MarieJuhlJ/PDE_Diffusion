...
python src/pde_diff/train.py model.name=unet3d_conditional experiment=era5_clean_hp3 id=ne_c1e3 k_folds=5 idx_fold=$LSB_JOBINDEX loss.name=vorticity loss.c_residual=1e-3
# python src/pde_diff/train.py model.name=unet3d_conditional experiment=era5_clean_hp3 id=ne_c1e1 loss.name=vorticity loss.c_residual=0.0
