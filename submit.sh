...
python src/pde_diff/train.py model.name=unet3d_conditional experiment=era5_clean_hp2_50e id=c1e1 k_folds=5 idx_fold=$LSB_JOBINDEX loss.name=vorticity loss.c_residual=1e-1
