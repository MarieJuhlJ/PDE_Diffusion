...
# python src/pde_diff/train.py model.name=unet3d_conditional experiment=era5_clean_hp3 id=baseline k_folds=5 idx_fold=$LSB_JOBINDEX loss.name=vorticity loss.c_residual=0.0
python src/pde_diff/train.py model.name=unet3d_conditional experiment=era5_clean_hp3 id=baseline_ne loss.name=vorticity loss.c_residual=0.0
