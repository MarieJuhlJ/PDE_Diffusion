...
python src/pde_diff/train.py model.name=unet3d_conditional experiment=era5_clean_hp_50e id=c1e2 k_folds=5 idx_fold=$LSB_JOBINDEX loss.name=vorticity loss.c_residual=1e-2
