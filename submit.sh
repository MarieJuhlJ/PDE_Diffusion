...
python src/pde_diff/train.py model.name=unet3d_conditional experiment=era5_clean_hp3_50e id=baseline k_folds=5 idx_fold=$LSB_JOBINDEX loss.name=vorticity loss.c_residual=0.0
